...
- If logs are written to a database implement SQL injection protection, see the [Vulnerability Mitigation: SQL Injection (SQLi)](/Web%20Application/Vulnerability%20Mitigation/SQL%20Injection/README.md) page.
